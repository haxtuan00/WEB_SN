...
five.forEach(function(five_element,index){
  five_element.addEventListener('click',function(e){
      switch(index){
          case 0: nav_product_h2.innerText='Hoa sáp 5 bông'
          break;
          case 1: nav_product_h2.innerText='Hoa sáp 11 bông'
          break;
          case 2: nav_product_h2.innerText='Hoa sáp 19 bông'
          break;
          case 3: nav_product_h2.innerText='Hoa sáp 21 bông'
          break;
      }
       e.preventDefault()
       window.scrollTo(0,0);
